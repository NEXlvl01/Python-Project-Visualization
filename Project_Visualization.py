...
def plot_project_categories(df_cleaned):
    ...
    plt.title('Project Count by Category', fontsize=16)
...
def plot_clone_projects(df_cleaned):
    ...
    plt.title('Clone Projects vs. Unique Projects', fontsize=16)
    plt.xlabel('Clone Project', fontsize=12)
    plt.ylabel('Number of Projects', fontsize=12)
    st.pyplot(plt.gcf())
...
def plot_group_projects(df_cleaned):
    ...
    plt.title('Group Projects vs. Individual Projects', fontsize=16)
    plt.xlabel('Group Project', fontsize=12)
    plt.ylabel('Number of Projects', fontsize=12)
    st.pyplot(plt.gcf())
...
def plot_technologies_used(df_cleaned):
    ...
    plt.title('Technologies Used in Projects', fontsize=16)
